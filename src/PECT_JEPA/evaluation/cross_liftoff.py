"""
Cross-Lift-off Generalization Evaluation for PECT-JEPA (Section 18.4).
...
def evaluate_cross_liftoff(
    ...
    print(f"Cross-Liftoff Eval [{test_liftoff}]: {len(train_files)} train files, {len(test_files)} test files")
