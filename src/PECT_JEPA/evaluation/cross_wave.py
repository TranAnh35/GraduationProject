"""
Cross-Wave Generalization Evaluation for PECT-JEPA (Section 18.3).
...
def evaluate_cross_wave(
    ...
    print(f"Cross-Wave Eval [{test_waveform}]: {len(train_files)} train files, {len(test_files)} test files")
