...
from src.PECT_JEPA.spatiotomporal_3d.data.dataset import PECTDataset, PECTClipDataset, find_all_tdms_files, collate_pect_batch
from src.PECT_JEPA.spatiotomporal_3d.data.split import split_by_files
from src.PECT_JEPA.spatiotomporal_3d.models.jepa import PECT_JEPA
from src.PECT_JEPA.spatiotomporal_3d.training.trainer import JEPATrainer
...
def main():
    ...
    train_dataset = PECTClipDataset(
        ...
        spatial_crop_size=config.data.spatial_crop_size,
        train=True,
        normalization=config.data.normalization,
        use_memmap=config.data.use_memmap,
